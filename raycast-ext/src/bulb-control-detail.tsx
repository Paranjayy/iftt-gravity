...
export default function BulbControlDetail() {
  ...
  const presetSection = {
    ...
    items: [
      ...
      { id: "bulb-timer-15m", title: "Bulb Off in 15 Minutes", icon: Icon.Clock, endpoint: "/control/bulb/timer?mins=15", name: "Bulb Timer 15m" },
      { id: "bulb-timer-30m", title: "Bulb Off in 30 Minutes", icon: Icon.Clock, endpoint: "/control/bulb/timer?mins=30", name: "Bulb Timer 30m" },
      { id: "bulb-timer-1h", title: "Bulb Off in 1 Hour", icon: Icon.Clock, endpoint: "/control/bulb/timer?mins=60", name: "Bulb Timer 1h" },
      { id: "bulb-timer-clear", title: "Clear Bulb Timer", icon: Icon.Xmark, endpoint: "/control/bulb/timer?mins=0", name: "Clear Bulb Timer" },
