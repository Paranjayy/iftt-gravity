# 🧠 Gravity God Build: AI Cortex Wishlist

This file archives user prompts, feature requests, and "missed insights" from Telegram.
Gravity looks into this file periodically to evolve.

## 🗒 Feature Requests & Improvements
- [x] PGVCL Scraper refinement (Verify login selectors)
- [ ] Smart Savings Mode: Auto-off lights if no sense detection for 20m
- [x] Solar tracking integration (Idea)
- [x] AC logging verification (Fixed in v2.1)
...
- [2026-04-08] User: "lookup into pgvcl price" (RESOLVED - Estimation added)
